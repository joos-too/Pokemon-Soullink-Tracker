export const de = {
  ...
  tracker: {
    ...
    infoPanel: {
      ...
      itemsHeading: "Items",
      itemsWidgetTooltip:
        "Dieses Widget ist dazu gedacht um die eigens verwendeten Items in den Top 4 zu tracken, da diese je nach Regelset auf z.B. 20 begrenzt sind. Alternativ kann es in Kämpfen genutzt werden, um die Anzahl der vom Gegner verwendeten Items zu tracken.",
