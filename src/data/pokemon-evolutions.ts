...
export const EVOLUTIONS_DE: Record<
  number,
  { id: number; methods: string[] }[]
> = {
  "1": [
    {
      id: 2,
  ...
  "19": [
    {
      id: 20,
      methods: ["Level-Up - Level 20", "Level-Up - Level 20, Tageszeit: Nacht"],
    },
  ],
  "21": [
    {
  ...
  "104": [
    {
      id: 105,
      methods: ["Level-Up - Level 28", "Level-Up - Level 28, Tageszeit: Nacht"],
    },
  ],
  "108": [
    {
...
export const EVOLUTIONS_EN: Record<
  number,
  { id: number; methods: string[] }[]
> = {
  "1": [
