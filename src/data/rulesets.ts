...
export const DEFAULT_SOLO_RULES: string[] = [
  ...
  "Geschenkte/Statische Pokémon & Fossile gelten nicht als Gebietspokémon und dürfen verwendet werden. Identische Statics & Fossile dürfen nur einmal verwendet werden.",
  "Wenn ein Pokémon beim Fangversuch flieht/stirbt, zählt das Gebiet als verloren.",
  ...
  "Das Level-Cap darf nicht überschritten werden (1 Pokémon auf höherem Level, restliche auf niedrigerem wenn vorhanden). Überlevelte Pokémon dürfen nicht verwendet werden, bis der Level-Cap wieder ansteigt.",
  ...
  "Challenge verloren, wenn das eigene Team komplett besiegt wurde.",
  ...
  "Max. 2 legendäre Pokémon im Team",
];
...
export const DEFAULT_TRIO_RULES: string[] = [
  "Pro Route/Gebiet darf nur das erste Pokémon gefangen werden. Dieses Pokémon ist mit dem Pokémon der Partner verbunden.",
  "Pokémon, die bereits gefangen wurden (oder deren Evolutionsreihe) zählen nicht als Routen Pokémon und dürfen gererolled werden. Es gibt max. 2 weitere Versuche.  Pokémon die bereits encountered aber nicht gefangen wurden sind nur individuell für die Person gesperrt",
  "Geschenkte/Statische Pokémon & Fossile gelten nicht als Gebietspokémon und dürfen verwendet werden (auch wenn bereits gefangen, auch mit Partnern verbunden). Identische Statics & Fossile dürfen nur einmal verwendet werden.",
  "Wenn ein Pokémon beim Fangversuch flieht/stirbt, zählt das Gebiet als verloren. Die Seelenpartner müssen freigelassen werden.",
  "Jedes Pokémon erhält einen Spitznamen.",
  "Besiegte Pokémon gelten als verstorben und müssen so wie ihre Seelenpartner in eine Grab-Box. (Wenn bereits im Kampf, Verwendung bis zum Ende)",
  "Pokémon, Items, und Trainer sind gerandomized.",
  "Der Bonusshop ist gerandomized, jedes Item darf max. 1 mal gekauft werden.",
  "Das Level-Cap darf nicht überschritten werden (1 Pokémon auf höherem Level, restliche auf niedrigerem wenn vorhanden). Überlevelte Pokémon sowie ihr Seelenpartner dürfen nicht verwendet werden, bis der Level-Cap wieder ansteigt.",
  "Sonderbonbons dürfen direkt VOR Arenaleiter/Top-4/Champion/Rivalen verwendet werden. Sie dürfen außerdem verwendet werden um Pokémon auf das Level-Cap der letzten Arena zu bringen.",
...
export const DEFAULT_SOLO_RULES_EN: string[] = [
  "Only the first Pokémon encountered on each route/area may be caught.",
  ...
  "Gift/static Pokémon and fossils do not count as area Pokémon and may be used. Identical statics and fossils may only be used once.",
  "If a Pokémon flees or faints during the catch attempt, the area is lost.",
  "Every Pokémon receives a nickname.",
  "Defeated Pokémon are considered dead and must be placed in a grave box.",
  "Pokémon, items, and trainers are randomized.",
  "The bonus shop is randomized; each item may only be purchased once.",
  "The level cap must not be exceeded (1 Pokémon may match the upper level, the rest must match the lower if existing). Overleveled Pokémon may not be used until the level cap increases again.",
  ...
  "Items in battle may only be used if the opponent also uses one. In the Pokémon League, a maximum of 20 items may be used outside of battles.",
  ...
  "Maximum of 2 legendary Pokémon in your team.",
];
...
export const DEFAULT_RULES_EN: string[] = [
  ...
  "Pokémon that have already been caught/encountered (or are in the same evolution line) do not count as route Pokémon and may be rerolled. Maximum 2 additional attempts.",
  "Gift/static Pokémon and fossils do not count as area Pokémon and may be used (even if already caught, also linked to partner). Identical statics and fossils may only be used once.",
  ...
  "Pokémon, items, and trainers are randomized.",
  "The bonus shop is randomized; each item may only be purchased once.",
  "The level cap must not be exceeded (1 Pokémon may match the upper level, the rest must match the lower if existing). Overleveled Pokémon and their soul partner may not be used until the level cap increases again.",
  "Rare Candy may be used directly BEFORE Gym Leader/Elite Four/Champion/Rival fights. They may also be used to bring Pokémon up to the level cap of the last gym.",
  "Battle style is set to 'Shift'.",
...
export const DEFAULT_TRIO_RULES_EN: string[] = [
  "Only the first Pokémon encountered on each route/area may be caught. This Pokémon is linked to the partner's Pokémon.",
  "Pokémon that have already been caught (or are in the same evolution line) do not count as route Pokémon and may be rerolled. Maximum 2 additional attempts. Encountered Pokémon that were not caught are only blocked individually for the person.",
  "Gift/static Pokémon and fossils do not count as area Pokémon and may be used (even if already caught, also linked to partners). Identical statics and fossils may only be used once.",
  "If a Pokémon flees or faints during the catch attempt, the area is lost. The linked soul partners must be released.",
  "Every Pokémon receives a nickname.",
  "Defeated Pokémon are considered dead and, together with their soul partners, must be placed in a grave box. (If already in battle, they may be used until the fight ends.)",
  "Pokémon, items, and trainers are randomized.",
  "The bonus shop is randomized; each item may only be purchased once.",
  "The level cap must not be exceeded (1 Pokémon may match the upper level, the rest must match the lower if existing). Overleveled Pokémon and their soul partners may not be used until the level cap increases again.",
  "Rare Candy may be used directly BEFORE Gym Leader/Elite Four/Champion/Rival fights. They may also be used to bring Pokémon up to the level cap of the last gym.",
  "Battle style is set to 'Shift'.",
  "Items in battle may only be used if the opponent also uses one. In the Elite Four, a maximum of 20 items may be used outside of battles.",
  "Shiny Pokémon may always be caught and may be swapped in freely.",
