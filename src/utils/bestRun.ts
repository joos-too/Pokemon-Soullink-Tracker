...
export const canToggleLevelAtIndex = (
  levelCaps: LevelCap[],
  index: number,
): boolean => {
...
export const canToggleRivalAtIndex = (
  rivalCaps: RivalCap[],
  index: number,
): boolean => {
