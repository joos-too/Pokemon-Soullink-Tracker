...
const UserSettingsPage: React.FC<UserSettingsPageProps> = ({email, onBack, onLogout, useGenerationSprites, onGenerationSpritesToggle, useSpritesInTeamTable, onSpritesInTeamTableToggle}) => {
