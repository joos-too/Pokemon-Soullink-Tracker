    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-300 dark:border-gray-700">
            ...
            <table className="w-full table-fixed border-collapse">
                ...
                <tr>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-8">#</th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-20"></th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-40">Pokémon</th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-40">Spitzname</th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-20"></th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-40">Pokémon</th>
                    <th className="p-2 text-xs font-bold text-gray-800 dark:text-gray-300 text-center border-t border-gray-300 dark:border-gray-700 w-40">Spitzname</th>
                ...
                {rows.map(({ pair, originalIndex }, index) => (
                    <tr key={pair.id} className="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td className="p-2 text-center text-sm text-gray-800 dark:text-gray-300 w-40">{pair.player1.name || '-'}</td>
                        <td className="p-2 text-center text-sm text-gray-800 dark:text-gray-300 border-r border-gray-200 dark:border-gray-700 w-40">{pair.player1.nickname || '-'}</td>
                        <td className="p-2 text-center w-20">
                        ...
                        <td className="p-2 text-center text-sm text-gray-800 dark:text-gray-300 w-40">{pair.player2.name || '-'}</td>
                        <td className="p-2 text-center text-sm text-gray-800 dark:text-gray-300 border-r border-gray-200 dark:border-gray-700 w-40">{pair.player2.nickname || '-'}</td>
