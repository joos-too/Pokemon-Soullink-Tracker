        ...
        <tbody>
          {data.map((pair, index) => (
            <tr key={pair.id} className="border-t border-gray-200 hover:bg-gray-50">
              ...
              <EditableCell value={pair.player1.nickname} onChange={(val) => onPokemonChange(index, 'player1', 'nickname', val)} className="border-r border-gray-200" />
              <EditableCell value={pair.player2.name} onChange={(val) => onPokemonChange(index, 'player2', 'name', val)} />
              <EditableCell value={pair.player2.nickname} onChange={(val) => onPokemonChange(index, 'player2', 'nickname', val)} className="border-r border-gray-200" />
