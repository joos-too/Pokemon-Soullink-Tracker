      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            <button type="button" onClick={onClose} className="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
              {cancelLabel}
            </button>
            <button type="submit" className="px-4 py-2 rounded-md font-semibold shadow bg-green-600 text-white hover:bg-green-700">
              {submitLabel}
            </button>
          </div>
        </form>
