      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end gap-2">
            ...
            <button type="submit" disabled={!isValid} className={`px-4 py-2 rounded-md font-semibold shadow ${isValid ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed'}`}>
              Hinzufügen
            </button>
          </div>
        </form>
