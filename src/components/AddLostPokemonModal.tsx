      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end gap-2">
            <button type="button" onClick={onClose} className={`px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 ${focusRingClasses}`}>{t('common.cancel')}</button>
